...
<html lang="en">
  <head>
    ...
    <title>Het Coronfonds Nepal</title>
  </head>
  <body>
     <header>
      <!-- Fixed navbar -->
      <nav class="navbar navbar-expand-md navbar-light bg-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
           <ul class="nav navbar-nav justify-content-end mr-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              <a class="nav-link" href="#waarom">Waarom het coronafonds? <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#wie">Voor wie en hoe?</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="#doneer" >Hoe kan ik helpen?</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#update_nepal">Corona update Nepal!</a>
            </li>
            <li class="nav-item">
          ...
          <form class="form-inline my-2 my-lg-0">
            <a class="btn btn-outline-info my-2 my-sm-0"  href="https://www.facebook.com/himal.ojha.9/videos/2850483641656133/UzpfSTEwMDAwMDgzNTc2NjYzNToyODYyMzkwNTAwNDY1NDQ3/">Volg laatste Corona Update</a>
          </form>
        </div>
      </nav>
    </header>
    ...
    <main role="main" class="container">
      <div class="textof">
        <h1 class="mt-5" id="waarom">Waarom het corona noodfonds?</h1>
        <p class="lead">
        ...
        <p>
          <img src="./img/1efoto.jpg" class="img-fluid"  alt="waarom het corona noodfonds">
        </p>
      ...
      <div class="textof">
        <h1 class="mt-5" id="wie">Voor wie en hoe komt het terecht?</h1>
        <p class="lead">
        ...
        <p>
          <img src="./img/2efoto.jpg" class="img-fluid"  alt="waarom het corona noodfonds">
        </p>
     ...
     <div class="textof">
      <h1 class="mt-5" id="doneer">Hoe kunt u helpen?</h1>
      <p class="lead">
          U draagt Nepal altijd al een warm hart toe waar we zeer dankbaar voor zijn. Ook nu is uw steun meer dan welkom!<br/>
          U kunt uw bijdrage overmaken naar:<br/>
          <code>NL49 ABNA 0471642002 t.a.v.: stichting NDA o.v.v. CoronaNepal</code>
          <img src="./img/anbi-logo.jpeg" class="ml-3" alt="...">
      </p>
    </div>

     <div class="textof">
      <h1 class="mt-5" id="contact">Contact</h1>
      <p class="lead">
        Stichting NDA</br>
       2e Oosterparklaan 157<br/>
       3544 AP Utrecht<br/>
       Tel.: 06-48182704<br/>
       Tel.: 06-48182704<br/>
     ...
     <div class="textof" style="padding-bottom: 90px">
      <h1 class="mt-5" id="update_nepal">Corona Update Nepal</h1>
      <p class="lead">
        <a class="nav-link" href="https://covid19.mohp.gov.np">https://covid19.mohp.gov.np <span class="sr-only">(current)</span></a>
      </p>
    </div>
    ...
    <footer class="footer">
      <div class="container textof">
        <span class="text-muted lead">Namaste & hartelijk dank voor uw steun!   </span>
      </div>
    </footer>
    <!-- Optional JavaScript -->
